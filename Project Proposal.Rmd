...
We hope to deliver a Shiny application with a map of the US or of the world. *The purpose of this is to * with interesting findings as to what type of meetups are most frequented in each place. This should provide a visual representation of the hubs for different meetups around the world by group topic.  We would like to see what types of activities most people like to meet up with strangers to do. 

* Right now we are pulling in two directions. The first is using the meetupr package to just create an informative shiny plot. The second is creating a package like meetupr that access meetup's rsvp data and generates a dataframe from the rsvp's as they appear. * 
